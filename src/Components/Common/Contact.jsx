...
//                             <h3 className="text-2xl font-bold text-yellowCustom mt-2">Get in Touch</h3>
//                             <p className="text-sm text-gray-600">We’re here to help your business grow</p>
//                         </div>
...
//                             <button
//                                 type="submit"
//                                 className="bg-yellowCustom text-black w-full py-2 rounded flex items-center justify-center transition"
//                             >
//                                 <Send className="w-4 h-4 mr-1" />{loading ? "Sending..." : "Send Message"}
//                             </button>
//                         </form>
//                         {feedback && (
//                             <div className="text-center text-sm text-green-600">{feedback}</div>
//                         )}
//                     </div>
...
//                                     <li><span className="font-medium">Monday to Friday:</span> 9AM – 6PM</li>
//                                     <li><span className="font-medium">Saturday:</span> 9AM – 6PM</li>
